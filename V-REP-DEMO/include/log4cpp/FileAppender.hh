...
namespace log4cpp {
    ...
    class LOG4CPP_EXPORT FileAppender : public LayoutAppender {
        ...
        **/
        ...
        virtual std::string ExtractFilePath(const std::string afile);
        virtual std::string ParseFilePath(const std::string aFile);
        virtual std::string GetEnvVar(const std::string anString, unsigned int *anIndex, bool * theError);
